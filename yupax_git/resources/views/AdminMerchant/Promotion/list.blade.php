                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/promotion/clear-search')}}" class="btn default btn-xs">Xóa</a>
                                </div>
                            </div>
        ...
        <div class="col-lg-12 col-xs-12 col-sm-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions ">
                        <a href="{{Asset('/merchant/promotion/add')}}" class="btn green btn-xs">
