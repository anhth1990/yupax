                ...
                <div class="portlet-body form">
                    ...
                    <div class="mt-element-step">
                        <div class="row step-thin">
                            ...
                            <div class="col-md-4 bg-grey mt-step-col ">
                                <div class="mt-step-number bg-white font-grey active">2</div>
                    ...
                    <form class="form-horizontal form-bordered">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    {{trans("common.promotion_type_".$addForm->getType())}}
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <img id="image" width="200px" src="{{Asset($addForm->getLinkImage())}}"/>
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    Từ {{$addForm->getDateFrom()}} 
                                    @if($addForm->getDateTo()!=null)
                                    Đến {{$addForm->getDateTo()}}
                                    @endif
                                    <!-- /input-group -->
                                </div>
                            </div>
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-3">
                                    <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/promotion/add-finish')}}" class="btn green btn-xs">
