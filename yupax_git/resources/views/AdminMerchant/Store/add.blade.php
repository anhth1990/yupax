        ...
        <div class="col-lg-12 col-xs-12 col-sm-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <!-- BEGIN FORM-->
                    <form action="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/store/add-confirm')}}" class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="<?php echo csrf_token();?>">
                        <input type="hidden" name="lat" id="lat" value="{{$addForm->getLat()}}">
                        <input type="hidden" name="long" id="long" value="{{$addForm->getLong()}}">
                        <div class="form-body">
                            <h3>Thông tin cửa hàng</h3>
                            <div class="form-group">
                                <label class="control-label col-md-3">Tên cửa hàng</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="Tên cửa hàng" name="name" value="{{$addForm->getName()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" name="dataFileLogo" id="select-logo">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="wysihtml5 form-control" name="description" rows="10">{{$addForm->getDescription()}}</textarea>
                                </div>
                            </div>
                            <h3>Chi nhánh</h3>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="Tên chi nhánh" name="nameBranch" value="{{$addForm->getNameBranch()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">&nbsp;</label>
                                <div class="col-md-4">
                                    <img id="image-branch" width="200px"/>
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="Số điện thoại" name="mobile" value="{{$addForm->getMobile()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="Email" name="email" value="{{$addForm->getEmail()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control timepicker timepicker-24" name="openTime" value="{{$addForm->getOpenTime()}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control timepicker timepicker-24" name="closeTime" value="{{$addForm->getCloseTime()}}">
                                        <span class="input-group-btn">
                                            <button class="btn default" type="button">
                                                <i class="fa fa-clock-o"></i>
                                            </button>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" id="address" placeholder="Địa chỉ" name="address" value="{{$addForm->getAddress()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
...
$(document).ready(function(){
    $('.wysihtml5').wysihtml5();
    $('#select-logo').change(function(e){
        var fileName = e.target.files[0].name;
        $("#image-logo").attr('src',window.URL.createObjectURL(e.target.files[0]));
    ...
    @if ($addForm->getAddress()!=null)
        getLatLong($("#address").val());
    @endif
    @if ($addForm->getProvinceId()!=null)
        $provinceId = $("#provinceId").val();
        $("#districtId").html(getDistrict($provinceId));
    @endif
    @if ($addForm->getDistrictId()!=null)
...
function getProvince(){
   ...
   @foreach ($listProvince as $province)
       $selected='';
      @if ($addForm->getProvinceId()!=null && $province->provinceid==$addForm->getProvinceId())
          $selected = 'selected'; 
      @endif 
...
function getDistrict($provinceId){
   ...
   @foreach ($listDistrict as $district)
      if({{$district->provinceid}} == $provinceId){
          $selected='';
           @if ($addForm->getDistrictId()!=null && $district->districtid==$addForm->getDistrictId())
               $selected = 'selected'; 
           @endif 
...
function getWard($districtId){
   ...
   @foreach ($listWard as $ward)
      if({{$ward->districtid}} == $districtId){
          $selected='';
           @if ($addForm->getWardId()!=null && $ward->wardid==$addForm->getWardId())
               $selected = 'selected'; 
           @endif 
