                    ...
                    <form class="form-horizontal form-bordered" >
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <img src="{{Asset($addForm->getLinkLogo())}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <h3>Chi nhánh</h3>
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-3">
                                    <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/store/detail/'.$addForm->getStoreHashcode())}}" class="btn green btn-xs">
