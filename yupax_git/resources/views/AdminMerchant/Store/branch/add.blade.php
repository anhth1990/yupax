        ...
        <div class="col-lg-12 col-xs-12 col-sm-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <!-- BEGIN FORM-->
                    <form action="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/store/branch/add-confirm')}}" class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="storeId" id="" value="{{$addForm->getStoreId()}}">
                        <input type="hidden" name="storeHashcode" id="" value="{{$addForm->getStoreHashcode()}}">
                        <input type="hidden" name="name" id="" value="{{$addForm->getName()}}">
                        <input type="hidden" name="linkLogo" id="" value="{{$addForm->getLinkLogo()}}">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <img src="{{Asset($addForm->getLinkLogo())}}" width="200px">
                                </div>
                            </div>
                            <h3>Chi nhánh</h3>
                            <div class="form-group">
