                    ...
                    <form class="form-horizontal form-bordered" >
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <img src="{{Asset($editForm->getLinkLogo())}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <h3>Chi nhánh</h3>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <img src="{{Asset($editForm->getLinkImages())}}" width="200px">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    {{$editForm->getCreatedAt()}}
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Ngày chỉnh sửa</label>
                                <div class="col-md-4">
                                    {{$editForm->getUpdatedAt()}}
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group last">
                                ...
                                <div class="col-md-3">
                                    <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/store/detail/'.$editForm->getStoreHashcode())}}" class="btn green btn-xs">
