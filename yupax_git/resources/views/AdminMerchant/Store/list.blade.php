                    ...
                    <form action="" method="POST" class="form-horizontal form-bordered">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="Tên cửa hàng" name="name" value="{{$searchForm->getName()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/store/clear-search')}}" class="btn default btn-xs">Xóa</a>
                                </div>
                            </div>
        ...
        <div class="col-lg-12 col-xs-12 col-sm-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions ">
                        <a href="{{Asset('/merchant/store/add')}}" class="btn green btn-xs">
                        ...
                        <table class="table table-striped table-bordered table-advance table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <img width="200px" alt="" class="img-circle" src="{{Asset($obj->logo)}}">
                                    </td>
                                    <td> 
                                        {{$obj->name}}
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/store/detail/'.$obj->hashcode)}}" class="btn green btn-xs btn-outline sbold uppercase">
                                            <i class="fa fa-share"></i> Chi tiết </a>
                                        <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/store/branch/add/'.$obj->hashcode)}}" class="btn green btn-xs btn-outline sbold uppercase">
                                            <i class="fa fa-plus"></i> Thêm chi nhánh </a>
                                    </td>
                                </tr>
                                    @endforeach
                                @endif
