...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">Chỉnh mới</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">Chỉnh mới</span>
                ...
                <div class="portlet-body form">
                    ...
                    <!-- BEGIN FORM-->
                    <form action="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/store/edit-confirm')}}" class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="Tên cửa hàng" name="name" value="{{$editForm->getName()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" name="dataFileLogo" id="select_file">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <img id="image-logo" src="{{Asset($editForm->getLinkLogo())}}" width="200px"/>
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="wysihtml5 form-control" name="description" rows="10">{{$editForm->getDescription()}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
