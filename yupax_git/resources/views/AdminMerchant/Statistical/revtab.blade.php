...
<div class="page-content">
    ...
    <div class="page-head">
        ...
        <div class="page-title">
            <h1>Chỉ số REVPASH ( vnd/bàn/ngày )
                <small><!-- ** --></small>
            </h1>
        </div>
        <!-- END PAGE TITLE -->
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/statistical/clear-search-revtab')}}" class="btn default">Xóa</a>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <div class="col-lg-12 col-xs-12 col-sm-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-bar-chart font-dark hide"></i>
                        <span class="caption-subject font-dark bold uppercase">Chỉ số REVPASH ( vnd/bàn/ngày )</span>
