                ...
                <div class="portlet-body form">
                    ...
                    <form action="" class="form-horizontal form-bordered" method="POST">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Khung giờ</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/statistical/clear-search-guestbill')}}" class="btn default">Xóa</a>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <div class="col-lg-12 col-xs-12 col-sm-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-bar-chart font-dark hide"></i>
                        <span class="caption-subject font-dark bold uppercase">Chỉ số khách hàng/hóa đơn</span>
