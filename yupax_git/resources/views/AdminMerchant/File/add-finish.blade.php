            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="alert alert-success">
                                        <strong>Thành công!</strong> Hoàn thành tải lên. </div>
                    <!-- BEGIN FORM-->
                    <form class="form-horizontal" role="form">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Loại dữ liệu:</label>
                                        <div class="col-md-9">
                                            <p class="form-control-static"> {{trans('common.file_'.$addForm->getType())}} </p>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-static"> {{$addForm->getName()}} </p>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Kiểu dữ liệu:</label>
                                        <div class="col-md-9">
                                            <p class="form-control-static"> {{$addForm->getExtension()}} </p>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-static"> {{trans('common.status_'.$addForm->getStatus())}} </p>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-static"> {{$addForm->getCreatedAt()}} </p>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                         ...
                         <div class="form-actions ">
                            <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/file/list')}}" class="btn green">
