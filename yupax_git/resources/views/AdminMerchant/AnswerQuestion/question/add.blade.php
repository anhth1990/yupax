...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/answer-question/detail/'.$addForm->getHashcodeAnswer())}}">Danh sách</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
             ...
             <div class="portlet light bordered" id="blockui_sample_1_portlet_body">
                ...
                <div class="portlet-body form">
                    ...
                    <form action="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/answer/question/add-confirm')}}" class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="hashcodeAnswer" value="{{$addForm->getHashcodeAnswer()}}">
                        <div class="form-body">
                            <h3>Câu hỏi</h3>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {{$addForm->getAnswer()}}
                                    <input type="hidden" name="answer" value="{{$addForm->getAnswer()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    {{trans('common.answer_question_type_'.$addForm->getType())}}
                                    <input type="hidden" name="type" value="{{$addForm->getType()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    {{trans('common.COMMON_STATUS_'.$addForm->getStatusAnswer())}}
                                    <input type="hidden" name="statusAnswer" value="{{$addForm->getStatusAnswer()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <h3>Câu trả lời</h3>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="Câu trả lời" name="name" value="{{$addForm->getName()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="checkbox" value="1" name="result" @if($addForm->getResult()==1) checked  @endif />
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
