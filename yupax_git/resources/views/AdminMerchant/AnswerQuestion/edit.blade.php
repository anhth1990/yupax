                    ...
                    <form action="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/answer-question/edit-confirm')}}" class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="Câu hỏi" name="answer" value="{{$editForm->getAnswer()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" name="type" id="">
                                        ...
                                        <option value="RATE" @if($editForm->getType()=='RATE')selected @endif >Khảo sát</option>
                                    </select>
                                    <!-- /input-group -->
                                </div>
                            </div>
