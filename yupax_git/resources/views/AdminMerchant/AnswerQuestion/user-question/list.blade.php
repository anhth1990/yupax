                ...
                <div class="portlet-body form">
                    ...
                    <form action="" method="POST" class="form-horizontal form-bordered">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Kết quả tìm thấy</label>
                                <div class="col-md-4">
                                    {{$countObj}}
                                    <!-- /input-group -->
                                </div>
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/answer-question/user/clear-search')}}" class="btn default btn-xs">Xóa</a>
                                </div>
                            </div>
                        ...
                        <table class="table table-striped table-bordered table-advance table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <i class="glyphicon glyphicon-phone"></i> {{$obj->user->mobile}}<br>
                                        <i class="glyphicon glyphicon-envelope"></i> {{$obj->user->email}}
                                    </td>
                                    <td class="">
