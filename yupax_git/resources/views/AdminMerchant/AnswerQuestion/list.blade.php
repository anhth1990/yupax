                    ...
                    <form action="" method="POST" class="form-horizontal form-bordered">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="" name="answer" value="{{$searchForm->getAnswer()}}">
                                    <!-- /input-group -->
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/answer-question/clear-search')}}" class="btn default btn-xs">Xóa</a>
                                </div>
                            </div>
        ...
        <div class="col-lg-12 col-xs-12 col-sm-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions ">
                        <a href="{{Asset('/merchant/answer-question/add')}}" class="btn green btn-xs">
                        ...
                        <table class="table table-striped table-bordered table-advance table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        {{trans('common.answer_question_type_'.$obj->type)}}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/answer-question/detail/'.$obj->hashcode)}}" class="btn green btn-xs btn-outline sbold uppercase">
                                            <i class="fa fa-share"></i> Chi tiết </a>
                                        <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/answer/question/add/'.$obj->hashcode)}}" class="btn green btn-xs btn-outline sbold uppercase">
                                            <i class="fa fa-plus"></i> Thêm câu trả lời </a>
                                    </td>
                                </tr>
                                @endforeach
                                @endif
