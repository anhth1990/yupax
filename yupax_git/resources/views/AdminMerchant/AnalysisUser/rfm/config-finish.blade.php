                    ...
                    <form class="form-horizontal form-bordered" >
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                @for ($i = 0; $i < $rankUser; $i++)
                                <div class="col-md-2">
                                    {{$analysisForm->getListFrequency()[$i]}}
                                    <!-- /input-group -->
                                </div>
                                @endfor
                                @endif
                            ...
                            <div class="form-group">
                                ...
                                @for ($i = 0; $i < $rankUser; $i++)
                                <div class="col-md-2">
                                    {{$analysisForm->getListMonetary()[$i]}}
                                    <!-- /input-group -->
                                </div>
                                @endfor
                                @endif
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-3">
                                   <a href="{{Asset('/'.env('PREFIX_ADMIN_MERCHANT').'/analysis-user/rfm/config')}}" class="btn green btn-xs">
                                            <i class="fa fa-check"></i> Cấu hình</a>
                                </div>
                            </div>
                        </div>
                    </form>
